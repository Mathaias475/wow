...
export class HomeComponent implements OnInit {
  ...
  cards = [
    ...
    {
      icon: "",
      text: "Monturas: información sobre las monturas de World of Warcraft",
      route: this.routes.Mounts.fullPath,
      btnText: "Ir a monturas",
    },
  ];

  ngOnInit(): void {
    this.setIconForCard(this.cards, 0, "bags", 4);
    this.setIconForCard(this.cards, 1, "classes", 10);
    ...
    this.setIconForCard(this.cards, 6, "mounts", 2);
    setTimeout(() => {
      this.showCards = true;
    }, 100);
  }
